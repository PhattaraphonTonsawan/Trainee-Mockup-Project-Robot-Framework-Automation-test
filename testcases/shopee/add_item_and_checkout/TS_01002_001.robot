...
*** Test Cases ***
TS_01002_001
    [Documentation]    ทดสอบการเพิ่มสินค้า 1 ชิ้นลงตะกร้าสินค้า เปิดหน้าตะกร้าสินค้า เพิ่มจำนวนสินค้า 1 ชิ้น และเปิดหน้าทำการสั่งซื้อ  ด้วยการเข้าสู่ระบบด้วย บัญชี google
    [Tags]    F_0001    TS_01002    TS_01002_001    add_item_and_checkout    verify_price_of_multiple_products    shopee
    ...
    login_feature.Select google account for login
