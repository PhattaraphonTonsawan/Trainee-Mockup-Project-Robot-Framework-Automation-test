...
*** Test Cases ***
TS_02004_001
    [Documentation]    ทดสอบการจัดเรียงการแสดงผลของ Product โดยเรียงตาม ราคาสินค้าจาก ราคาสูง ไป ราคาต่ำ
    [Tags]    F_0002    TS_02004    TS_02004_001    sorting    standard_user
    ...
    product_list_page.Select sort type option    option=${dropdown_list['price_hi_to_lo']}
    # ตรวจสอบความถูกของการ sort
    product_list_feature.Verfiy products are sorted by price from high to low