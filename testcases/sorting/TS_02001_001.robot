...
*** Test Cases ***
TS_02001_001
    [Documentation]    ทดสอบการจัดเรียงการแสดงผลของ Product โดยเรียงตาม ชื่อสินค้าตามตัวอักษรภาษาอังกฤษจาก A ไป Z ว่าสามารถเรียงได้ถูกต้อง
    [Tags]    F_0002    TS_02001    TS_02001_001    sorting    standard_user
    ...
    product_list_page.Select sort type option    option=${dropdown_list['a_to_z']}
    # ตรวจสอบความถูกของการ sort
    product_list_feature.Verify products are sorted by name from a to z