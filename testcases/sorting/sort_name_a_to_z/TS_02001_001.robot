...
TS_02001_001
    ...
    product_list_page.Click deopdown sort button
    product_list_page.Click choose sort type    sort_type=${product_list_page_locator['ddl_a_to_z']}
    # ตรวจสอบความถูกของการ sort
    product_list_feature.Verify product sorted by name a to z