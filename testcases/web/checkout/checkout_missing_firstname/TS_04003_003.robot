...
*** Test Cases ***
TS_04003_003
    [Documentation]    สั่งซื้อสินค้าได้ 1 ชิ้นแต่ไม่กรอกชื่อจริงโดยใช้ บัญชีผู้ใช้ performance_glitch_user
    [Tags]    F_0004    TS_04003    TS_04003_003    checkout_missing_firstname    performance_glitch_user
