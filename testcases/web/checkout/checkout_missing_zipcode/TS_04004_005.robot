...
*** Test Cases ***
TS_04004_005
    [Documentation]    สั่งซื้อสินค้าได้ 1 ชิ้นแต่ไม่กรอกรหัสไปรษณีย์โดยใช้ บัญชีผู้ใช้ visual_user
    [Tags]    F_0004    TS_04004    TS_04004_005    checkout_missing_zipcode    visual_user
