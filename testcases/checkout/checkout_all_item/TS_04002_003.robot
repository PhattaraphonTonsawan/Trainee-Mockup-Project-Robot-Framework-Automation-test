...
*** Test Cases ***
TS_04002_003
    [Documentation]    สั่งซื้อสินค้าทุกชิ้นสำเร็จโดยใช้ บัญชีผู้ใช้ performance_glitch_user
    [Tags]    F_0004    TS_04002    TS_04002_003    checkout_all_item    performance_glitch_user
    ...
    # ตรวจสอบว่าอยู่หน้า checkout overview และสามารถ checkout ได้สำเร็จด้วยทุกชิ้น
